...
type LegacyFeature struct {
	...
	ApproximateDisableDate time.Time `json:"approximate_disable_date,omitempty"`
	// Approximate date that this feature will be removed.
	ApproximateEndOfLifeDate time.Time `json:"approximate_end_of_life_date,omitempty"`
